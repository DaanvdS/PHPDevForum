...
if(isLoggedIn() && isAdmin()){
	...
	if(isset($_GET['mode'])){
		...
		echo "<form id='get' method='post'><input type='hidden' name='p' value='adminpanel'><input type='hidden' name='mode' value='gitpull'><input type='submit' value='Git pull' /></form>";
