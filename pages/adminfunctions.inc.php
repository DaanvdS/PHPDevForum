...
function adminShowUserPanel(){
	...
	if(isset($_GET['action'])){
		...
		if($MySQL['result']->num_rows !== 0){
			...
			?><div class='item-container'><h1>User management</h1><table style='width: 100%;'><tr>
...
function adminShowGroupPanel(){
	...
	if(isset($_GET['action'])){
		...
		if($_GET['action'] == "delgroup"){
			...
			if($MySQL['result']->num_rows !== 0){
				//Displaying the adminpanel table and data
				?><div class='item-container'><h1>Assign users to <?php echo $_GET['name']; ?></h1><table><tr>
				...
				echo "<tr><td colspan='5'><input type='hidden' name='i' value='".$i."'><input type='submit' value='Save'></td></tr></form></table></div>";
			} else {
		...
		if($MySQL['result']->num_rows !== 0){
			//Displaying the adminpanel table and data
			?><div class='item-container'><h1>Group management</h1><table><tr>
