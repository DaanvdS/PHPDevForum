		...
		<div id="container">
			<div id="header">
				...
				<div id="account-info">
					...
					if(isLoggedIn()){
						include('dbconnect.inc.php');
						$MySQL['result'] = $MySQL['connection']->query("SELECT COUNT(*) AS `amountOfRows` FROM `messages` WHERE `receiverID`='".$_SESSION['forumUserID']."' AND `unread` = '1' OR `senderID`='".$_SESSION['forumUserID']."' AND `unread` = '1'");
						$MySQL['row']=$MySQL['result']->fetch_assoc();
